...
local Window = Rayfield:CreateWindow({
	Name = "  |discord.gg/r3T78cYzSs|      Atul's Script hub",
	LoadingTitle = "Welcome to Atul's  Script hub",
	LoadingSubtitle = "Welcome to Atul' Script hub",
	ConfigurationSaving = {
		Enabled = true,
        ...
        Discord = {
        	Enabled = true,
        	Invite = "Z9T7PNramP", -- The Discord invite code, do not include discord.gg/
        	RememberJoins = false -- Set this to false to make them join the discord every time they load it up
        },
	KeySystem = true, -- Set this to true to use our key system
	KeySettings = {
		Title = "Atul's key system!",
		Subtitle = "Key System",
		Note = "Join the discord FOR KEY discord.gg/r3T78cYzSs",
		FileName = "KEY SYSTEM",
		SaveKey = true,
...
local main = cool:CreateToggle({
	Name = "FULL GODMODE",
	CurrentValue = false,
	Flag = "Toggle1", 
	Callback = function()
		loadstring(game:HttpGet("https://pastebin.com/raw/zBAwPd4S"))()
	end,
})
...
local dahoodscripts = Window:CreateTab("Suggested scripts!", 448336245) -- Title, Image
local Section = dahoodscripts:CreateSection("Ur scripts u wanted")



local scripts11 = dahoodscripts:CreateButton({
	Name = "vortex da hood sent by  Leqso#7210",
	Callback = function()
...
local scripts11 = dahoodscripts:CreateButton({
	Name = "ro beats script  sent by  chara#2678",
	Callback = function()
		loadstring(game:HttpGet('https://getexploits.com/key-system/',true))('https://da.com/292406321490427914/864143078963937290/RoBeats_AUTO_PLAYER_JULY_2021_OPEN_SOURCE.txt')
	end,
})
